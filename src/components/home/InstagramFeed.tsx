      ...
      <div className="mx-auto max-w-7xl px-4">
          ...
          {posts.map((post) => (
            ...
            >
              ...
              {post.mediaType === "VIDEO" && (
                <div className="absolute left-2 top-2 rounded bg-black/60 p-1">
        ...
        <div className="mt-8 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-lg border-2 border-pink-500 px-6 py-3 font-semibold text-pink-600 transition-colors hover:bg-pink-500 hover:text-white"
          >
